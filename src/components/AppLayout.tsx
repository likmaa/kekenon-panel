  ...
  return (
    <NavLink
      ...
      className={({ isActive }: { isActive: boolean }) =>
        ...
        ${isActive
          ? 'bg-gradient-to-r from-primary/25 to-primary/5 text-dark font-bold border-l-4 border-primary'
    ...
    <div className="space-y-0.5">
      <button
        ...
        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
          ${isOpen
            ? 'text-dark font-bold bg-primary/15'
            : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900'
          }`}
      >
        {icon}
  ...
  const sidebarContent = (onClick?: () => void) => (
    <div className="flex-1 flex flex-col overflow-y-auto">
      ...
      <div className="p-3 border-t border-gray-200">
        ...
        >
          <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-dark text-sm font-bold group-hover:bg-primary transition-colors overflow-hidden">
            {user?.photo ? (
          ...
          <Settings size={14} className="text-gray-400 group-hover:text-dark transition-colors" />
        </Link>
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 flex-shrink-0">
          ...
          <button onClick={() => setSidebarOpen(false)} className="p-1 text-gray-500 hover:text-dark rounded-full">
            <X size={24} />
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col lg:pl-64">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            <button className="text-gray-500 hover:text-dark"><Bell size={20} /></button>
